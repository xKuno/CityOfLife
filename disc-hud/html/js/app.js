...
window.addEventListener('message', function (event) {
    ...
    switch(event.data.action) {
        case 'tick':
            ...
            if (event.data.speed >= event.data.speedLimit) {
        ...
        case 'change':
            ...
            break
        case 'updateStatus':
            updateStatus(event.data.hunger, event.data.thirst, event.data.stress, event.data.drunk);
            break;
        case 'hidecar':
            $('.car').fadeOut();
            break;
...
function updateStatus(hunger, thirst, stress, drunk){
    $('#boxHunger').css('width', hunger + '%')
    $('#boxThirst').css('width', thirst + '%')
    $('#boxDrunk').css('width', drunk + '%')
    $('#boxStress').css('width', stress + '%')
}
