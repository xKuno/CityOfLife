...
rootMenuConfig =  {
    ...
    },
    {
        ...
        subMenus = {"cuffs:cuff", "cuffs:softcuff", "cuffs:uncuff", "police:escort", "cuffs:checkinventory", "police:revive", "police:gsr", "police:openmdt", "police:getid", "police:spikes"}
    },
    {
        id = "police-vehicle",
        ...
        subMenus = {"police:putinvehicle", "police:unseatnearest", "police:runplate", "police:impound" --[[ "police:toggleradar" ]]}
    },
    {
        id = "policeDead",
        displayName = "10-13",
...
--[[     {
    ...
    --[[{
        ...
        enableMenu = function()
           ...
           PlayerData = ESX.GetPlayerData()
           fuck = exports["esx_ambulancejob"]:GetDeath()
            if PlayerData.job.name == "security" and not fuck then
                return true
            end
        end,
        subMenus = {}
...
--[[     ['general:checkvehicle'] = {
    ...
    ['mechanic:repair'] = {
        title = "Repair",
        icon = "#police-vehicle",
        functionName = "esx_mechanicjob:onFixkit"
    },
    ['mechanic:clean'] = {
        title = "Clean",
        icon = "#police-vehicle",
        functionName = "esx_mechanicjob:onClean"
    },
    ['mechanic:impound'] = {
        title = "Impound",
        icon = "#police-vehicle",
