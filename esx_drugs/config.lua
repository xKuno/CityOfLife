...
Config.CircleZones = {
	...
	--Coke
	CokeField = {coords = vector3(-2201.26, 5130.42, 12.72), blimpcoords = vector3(-2201.26, 5130.42, 12.72), name = _U('blip_CokeFarm'), color = 4, sprite = 501, radius = 0.0, enabled = true},
