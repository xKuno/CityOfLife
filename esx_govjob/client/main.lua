...
AddEventHandler('esx_phone:cancelMessage', function(dispatchNumber)
	if ESX.PlayerData.job and ESX.PlayerData.job.name == 'government' and ESX.PlayerData.job.name == dispatchNumber then
...
AddEventHandler('esx_governmentjob:hasEnteredMarker', function(station, part, partNum)
...
AddEventHandler('esx_governmentjob:hasExitedMarker', function(station, part, partNum)
...
AddEventHandler('esx_governmentjob:hasExitedEntityZone', function(entity)
...
Citizen.CreateThread(function()
	while true do
		...
		if ESX.PlayerData.job and ESX.PlayerData.job.name == 'government' then
			...
			if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum)) then
				...
				then
					TriggerEvent('esx_governmentjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
					hasExited = true
				end
				...
				TriggerEvent('esx_governmentjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
			end
...
Citizen.CreateThread(function()
	while true do
		...
		if CurrentAction then
			...
			if IsControlJustReleased(0, 38) and ESX.PlayerData.job and ESX.PlayerData.job.name == 'government' then
...
AddEventHandler('onResourceStop', function(resource)
	if resource == GetCurrentResourceName() then
		TriggerEvent('esx_phone:removeSpecialContact', 'government')
	end
end)