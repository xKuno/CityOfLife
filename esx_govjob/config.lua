...
Config.MarkerColor                = {r = 60, g = 204, b = 60}
...
Config.AuthorizedVehicles = {
	car = {
		recruit = {
			{model = 'dilettante', props = {color1 = 125, color2 = 125, pearlescentColor = 125}, price = 0},
			{model = 'caddy', props = {color1 = 125, color2 = 131, pearlescentColor = 131}, price = 0}, 
		},

		officer = {
			{model = 'dilettante', props = {color1 = 125, color2 = 125, pearlescentColor = 125}, price = 0},
			{model = 'caddy', props = {color1 = 125, color2 = 125, pearlescentColor = 125}, price = 0},
	...
	helicopter = {
		...
		captain = {
			{model = 'maverick', props = {modLivery = 1, color1 = 125, color2 = 125, pearlescentColor = 125}, price = 0}
		},
...
--	props = {color1 = 131, color2 = 125, pearlescentColor = 125}