...
Config.LicenseEnable       = false -- Require people to own a Aircraft License when buying Vehicles? Requires esx_license
...
Config.Zones = {
	ShopEntering = { -- Marker for Accessing Shop
		Pos   = { x = -927.6, y = -2936.84, z = 12.96 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = 1
	},
	ShopInside = { -- Marker for Viewing Vehicles
		Pos     = { x = -996.6, y = -3008.72, z = 13.96 }, -- { x = -1075.01, y = -2933.22, z = 14.55 },
		Size    = { x = 1.5, y = 1.5, z = 1.0 },
		Heading = 333.95, -- 59.9
		Type    = -1
	},
