...
Config.HeadInjuryTimer = 200
Config.ArmInjuryTimer = 200
Config.LegInjuryTimer = 200

--[[
    The Chance, In Percent, That Certain Injury Side-Effects Get Applied
]]
Config.HeadInjuryChance = 5
Config.ArmInjuryChance = 2
Config.LegInjuryChance = {
    Running = 2,
    Walking = 3
}

Config.ArmorStaggerChance = 10 -- Note : Small caliber weapons are this % halved
...
Config.Weapons = {
    ...
    [`WEAPON_MARKSMANRIFLE`] = Config.WeaponClasses['SMALL_CALIBER'],
    ...
    [`WEAPON_MUSKET`] = Config.WeaponClasses['SMALL_CALIBER'],
