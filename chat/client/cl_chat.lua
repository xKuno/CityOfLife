...
AddEventHandler('chat:toggleChat',function(hide)
  if hide == nil then chatVisibilityToggle = not chatVisibilityToggle end
  if hide then chatVisibilityToggle = true else chatVisibilityToggle = false end

  SendNUIMessage({
	type = 'ON_SCREEN_STATE_CHANGE',
	shouldHide = chatVisibilityToggle
  })
end)
...
Citizen.CreateThread(function()
  ...
  TriggerEvent('chat:addSuggestion', '/twt', 'Twitter chat')
end)
