(function(){
	let MenuTpl =
		'<div id="menu_{{_namespace}}_{{_name}}" class="menu{{#align}} align-{{align}}{{/align}}">' +
			'<div class="head_"><span id="headtext">Ozark RP</span></div>' +
				'<div class="categorie"><span id="catText">{{{title}}}</span></div>' +
					'<div class="menu-items">' +
						'{{#elements}}' +
							'<div id="itemText" class="menu-item {{#selected}}selected{{/selected}}">' +
