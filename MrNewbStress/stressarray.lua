local weaponstress = {
	...
	[-1076751822] = 1000, -- SNS PISTOL
	[-1813897027] = 1000, -- Grenade	
	[741814745] = 1000, -- StickyBomb		
	[-494615257] = 1000, -- AssaultShotgun		
	[-619010992] = 750, -- machine pistol
	[2024373456] = 1000, -- smg mk2
	[-270015777] = 1000, -- assault smg
	[171789620] = 1000, -- combat pdw
	[-1660422300] = 1000, -- mg
	[2144741730] = 1000, -- combat mg
	[3686625920] = 1000,
	[1627465347] = 1000,
	[-1121678507] = 1000,
	[-1074790547] = 1000,
	...
	[-1600701090] = 1000,
	[615608432] = 1000,
	[101631238] = 0, -- fire extinguisher
	[883325847] = 0, -- jerry can
	[1233104067] = 0, -- flare
	[600439132] = 0, -- ball
	[126349499] = 0, -- snowball
	[-37975472] = 250, -- smoke grenade
	[-1169823560] = 1000,
	[-1045183535] = 1000,
	[-598887786] = 1000,
	[-771403250] = 1000,
...
Citizen.CreateThread(function()
    while true do
		...
		local stress = weaponstress[weapon] or 1000
		if IsPedShooting(ped) and weaponstress[weapon] > 0 then
		  TriggerEvent('esx_status:add', 'stress', weaponstress[weapon])
		end
	end
end)
