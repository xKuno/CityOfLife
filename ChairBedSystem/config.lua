...
Config.objects = {
	...
	locations = {
		...
		[11] = {object=538002882, verticalOffsetX=0.0, verticalOffsetY=-0.0, verticalOffsetZ=0.1, direction=180.0, bed=false},
		[12] = {object=-1118419705, verticalOffsetX=-0.0, verticalOffsetY=0.1, verticalOffsetZ=-0.5, direction=180.0, bed=false},
		[13] = {object=2040839490, verticalOffsetX=-0.0, verticalOffsetY=0.1, verticalOffsetZ=0.0, direction=180.0, bed=false},
	}
}